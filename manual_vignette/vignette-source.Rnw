...
\noindent Contact the author if you have a problem installing the package.
...
Her.na <-  with(pops.adjusted_na,
                calcDivRat(ref = refHe, SEref = refSEHe, obs = He,
                           SEobs = SEHe, type = "He"))
pops.adjusted_na <- cbind(adjusted_na, Ar.na, Her.na)
pops.adjusted_na[, c("Population","Ar","SEAr","Her","SEHer")]
@
...
Her.cant <- with(pops.adjusted_cant,
                 calcDivRat(ref = refHe, SEref = refSEHe, obs = He,
                         SEobs = SEHe, type = "He"))
pops.adjusted_cant <- cbind(adjusted_cant, Ar.cant, Her.cant)
